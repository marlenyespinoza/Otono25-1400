...
try:
    # TODO: Cambia 'solution_m9_ex2' por 'student_code_m9_ex2' si estás usando el código del estudiante.
    # from solution_m9_ex2 import eliminar_elemento
    from m9_ocurrencias_ej2 import eliminar_elemento
except ImportError:
    pytest.fail(
